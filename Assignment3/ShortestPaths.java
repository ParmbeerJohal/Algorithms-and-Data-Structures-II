...
class heap {
	...
	public void swap(Vertex[] array, int index1, int index2) { // used to swap 2 tasks, used for parent/child swaps in the heap array.
		Vertex temp1 = array[index1];
...
*/
		...
		vertexList[source].shortestDistance = 0;
		ArrayList<Vertex> path = new ArrayList<Vertex>();
		PriorityQueue<Integer> closestV = new PriorityQueue<Integer>(n);
		closestV.add(source);
	...
	//TODO: Your code here
		for (int i = 0; i < n; i++){
			System.out.println("The path from " + source + " to " + i + " is: " + vertexList[i].shortestDistance + " and the total distance is: " + vertices[i].path);
		}
    }
